...
function isServiceItem(x){return !!(x&&(x.ecPickup===true||x.collectionPayment===true||x.billPayment===true||x.utilityPayment===true||x.yijiaPayReload===true||['bill','utility-bill','ec-pickup','collection','yijiapay-reload'].includes(String(x.serviceType||''))))}
...
export function checkout(paymentDetail=null){
 ...
 const sale={
  ...
  yijiaPayCode:String(detail.yijiaPayCode||''),
  yijiaPayAmount:Number(detail.yijiaPayAmount||0),
  yijiaPayBalanceBefore:Number(detail.yijiaPayBalanceBefore||0),
  yijiaPayBalanceAfter:Number(detail.yijiaPayBalanceAfter||0),
